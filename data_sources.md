...
Five sources, in order of preference:

1. **Maskína's own PDF report** at `maskina.is/wp-content/uploads/YYYY/MM/YYYY-MM-DD-Fylgi-Althingi_Maskinuskyrsla.pdf` (or `…_Maskinuskyrsla-N.pdf` when multiple). Authoritative for `svarendur`, field period, and per-party percentages. Discoverable via WebSearch (`site:maskina.is "<month> <year>"`) or by walking the news listing at [`maskina.is/frettir/`](https://maskina.is/frettir/) — each monthly poll gets its own news article whose body links to the PDF. **Definitive list:** WordPress's media API, `https://maskina.is/wp-json/wp/v2/media?search=Fylgi-Althingi&per_page=100`, returns every uploaded report (11 since the election as of 2026-09-23); a reading absent from it is a media-only release with no PDF. The PDFs are PowerPoint exports whose `pdftotext` output is fragmented glyph-by-glyph: strip all whitespace, then match `Könnuninfórframdagana…`/`Súfyrrivarframkvæmddagana…` for the field period and `Gildsvör([\d.]+)100,0%` for `svarendur`.
2. **Maskína dashboard** at [`maskina.is/fylgi-flokka-a-althingi/`](https://maskina.is/fylgi-flokka-a-althingi/). Tableau Public viz with five tabs (Nýjasta mæling, Þróun fylgis, Mín ríkisstjórn, Samanlagt fylgi, Hreyfing á fylgi) covering every Maskína monthly poll back to Nov 2021. The `Veldu mælingu` dropdown switches the displayed measurement; the "Bakgrunnur" panel shows `svarendur` for the selected poll. No `.csv` export (`allowDataAccess: false`), **but it yields exact `svarendur` for every reading, including media-only ones:** open `public.tableau.com/views/FylgiFlokka-heimasa/Njastamling?:embed=y&:showVizHome=no` in a browser, pick the reading in `Veldu mælingu (Bakgrunnur)`, and hover each segment of the `Allir` bar. The tooltip (`.tab-tooltipContent`, plain DOM text) gives the party's `Hlutfall` and `Fjöldi`, and the `Fjöldi` values (weighted counts) sum to the published `svarendur`. The sum is exact for the three readings with an independently published n: 2025-07 (PDF `Gild svör` 1.855), 2026-01 (Vísir 886) and 2026-08 (RÚV/Vísir 3.172). It is within the rounding or sub-pixel slack for 2025-01, 2025-03 and 2026-04-29 (article or Wikipedia n). Hovers must be real mouse input; synthetic JS events are ignored. **Do not trust the dashboard's free-text methodology line**: for 2026-08 it says "3.460 svarendur" while the counts sum to 3.172, which matches RÚV and Vísir.
...
4. **Vísir's Infogram charts**, embedded in every Vísir Maskína write-up and edited in place (the IDs are stable across months): the bar chart [`e.infogram.com/120df4ad-46bb-41ce-be41-e7f86616dbde`](https://e.infogram.com/120df4ad-46bb-41ce-be41-e7f86616dbde) has every reading since April 2023 labelled by publication date, and the line chart [`e.infogram.com/68399b2f-2841-4338-91fe-7c17c3b3317c`](https://e.infogram.com/68399b2f-2841-4338-91fe-7c17c3b3317c) has one row per month since 2021. Both carry 1-dp values in `window.infographicData` (curl-able JSON). They are good for discovering and reconciling readings but are not error-free (2025-08 B is 6,3 in the bar chart against 6,5 in the PDF; 2025-11 M is 17,2 in the line chart against 17,3 on the dashboard), so a PDF or the dashboard wins on conflict.
5. **Wikipedia's polling table** ([Next Icelandic parliamentary election](https://en.wikipedia.org/wiki/Next_Icelandic_parliamentary_election)) is a useful independent check on `svarendur`, where it matches the dashboard sums. Its fieldwork dates are incomplete ("?–26 Feb 2025") and sometimes wrong ("?–22 Jun 2025" against the PDF's 20.–24. júní).

| Date | n_total | Source | Notes |
|---|---|---|---|
| 2024-12-12 | 2,803 | [PDF](https://maskina.is/wp-content/uploads/2025/01/2024-12-Fylgi-Althingi_Maskinuskyrsla.pdf) ([Vísir](https://www.visir.is/g/20242669675d/flokkur-folksins-dalar-eftir-kosningar)) | Fielded 5.–19. desember 2024; svarendur 2.803 (PDF `Gild svör`). First post-election Maskína. **UPGRADED 2026-09-23: the values were whole-number roundings (S 23 / D 16 / …) and are now the PDF's 1-dp table**: S 23,1 / D 16,3 / C 16,5 / F 10,6 / M 9,0 / B 8,4 / J 6,0 / P 5,2 / V 3,8. Annað 1,1 (Lýðræðisflokkurinn 0,7 + Ábyrg framtíð 0,4) |
| 2025-01-11 | 966 | [Vísir](https://www.visir.is/g/20252681625d/sjalf-staedisflokkur-baetir-mest-vid-sig-i-nyrri-konnun) ([maskina.is dashboard](https://maskina.is/fylgi-flokka-a-althingi/)) | Fielded 9.–14. janúar 2025; svarendur 966 ("Könnunin fór fram dagana 9. til 14. janúar 2025 og voru 966 svarendur sem tóku afstöðu til flokks"). **BACKFILLED 2026-09-23**. Media-only release (no PDF). Values come from the dashboard's `Allir` tooltips and equal Vísir's Infogram. The counts sum to 961 plus a sub-pixel ≈0,6% sliver, consistent with 966. Lýðræðisflokkurinn 1,4 |
| 2025-02-19 | 2,899 | [Vísir](https://www.visir.is/g/20252694395d/flokki-folksins-einum-refsad) ([maskina.is dashboard](https://maskina.is/fylgi-flokka-a-althingi/), [Wikipedia](https://en.wikipedia.org/wiki/Next_Icelandic_parliamentary_election)) | **The field period was never published, so the date is ESTIMATED.** Fieldwork ended 26. febrúar 2025: Wikipedia gives "?–26 Feb 2025", and a same-wave Maskína survey on bank mergers ran 21.–26. febrúar (Vísir 28 Feb). The start is unknown, so the date is end − 7 d, Maskína's median end-to-midpoint half-span over 11 dated readings. svarendur 2.899 is the sum of the dashboard's `Fjöldi` counts, including Lýðræðisflokkurinn 41 and Ábyrg framtíð 31, and Wikipedia agrees. **BACKFILLED 2026-09-23**. Media-only |
| 2025-03-12 | 1,899 | [Vísir](https://www.visir.is/g/20252706568d/sjalf-staedis-flokkur-skakar-sam-fylkingu) ([maskina.is dashboard](https://maskina.is/fylgi-flokka-a-althingi/), [Wikipedia](https://en.wikipedia.org/wiki/Next_Icelandic_parliamentary_election)) | Fielded 5.–19. mars 2025 ("Könnunin var gerð á dögunum 5. til 19. mars"); svarendur 1.899 per Wikipedia. The dashboard counts over the nine parties sum to 1.898, and the missing 0,1% is a sub-pixel remainder. **BACKFILLED 2026-09-23**. Media-only. First post-election Maskína reading with **D ahead of S** (24,3 against 23,3); RÚV's `pollsArray` agrees |
| 2025-04-15 | 1,453 | [maskina.is dashboard](https://maskina.is/fylgi-flokka-a-althingi/) ([Wikipedia](https://en.wikipedia.org/wiki/Next_Icelandic_parliamentary_election)) | **The field period was never published, so the date is ESTIMATED.** No write-up was found in Vísir, RÚV, mbl or frettasafn. Wikipedia gives "?–22 Apr 2025", so the date is end − 7 d. svarendur 1.453 is the sum of the dashboard counts (the nine parties sum to 100,0%), and Wikipedia agrees. **BACKFILLED 2026-09-23**. The Infogram labels this reading only "apríl 2025" |
| 2025-05-15 | 1,962 | [PDF](https://maskina.is/wp-content/uploads/2025/05/2025-05-Fylgi-Althingi_Maskinuskyrsla.pdf) ([maskina.is](https://maskina.is/samfylkingin-baetir-i/)) | Fielded 9.–22. maí 2025; svarendur 1.962 (PDF `Gild svör`). **BACKFILLED 2026-09-23**. Midpoint 15,5 floored |
| 2025-06-22 | 876 | [PDF](https://maskina.is/wp-content/uploads/2025/06/2025-06-Fylgi-Althingi_Maskinuskyrsla.pdf) ([maskina.is](https://maskina.is/samfylkingin-afram-staersti-flokkurinn/)) | Fielded 20.–24. júní 2025; svarendur 876. **BACKFILLED 2026-09-23**. Wikipedia's "?–22 Jun" is wrong |
| 2025-07-13 | 1,855 | [PDF](https://maskina.is/wp-content/uploads/2025/08/2025-07-Fylgi-Althingi_Maskinuskyrsla.pdf) ([maskina.is](https://maskina.is/fylgi-flokkana-a-landsvisu-i-juli/)) | Composite: 4.–10. júlí + 18.–23. júlí 2025; svarendur 1.855. **BACKFILLED 2026-09-23**. **Calibration reading for the dashboard method**: all nine tooltip `Fjöldi` values equal the PDF table exactly. Midpoint of 4–23 July floored |
| 2025-08-14 | 2,228 | [PDF](https://maskina.is/wp-content/uploads/2025/08/2025-08-Fylgi-Althingi_Maskinuskyrsla.pdf) ([maskina.is](https://maskina.is/nanast-engar-breytingar-a-fylgi-flokkanna-a-milli-manada/)) | Composite: 7.–12. ágúst + 18.–21. ágúst 2025; svarendur 2.228. **BACKFILLED 2026-09-23**. **B 6,5 per the PDF; Vísir's Infogram bar chart has 6,3 (its line chart has 6,5)** |
| 2025-09-11 | 1,713 | [PDF](https://maskina.is/wp-content/uploads/2025/09/2025-09-Fylgi-Althingi_Maskinuskyrsla.pdf) ([maskina.is](https://maskina.is/litlar-breytingar-a-fylgi-flokkanna/)) | Composite: 4.–9. september + 15.–19. september 2025; svarendur 1.713. **BACKFILLED 2026-09-23**. Midpoint 11,5 floored |
| 2025-10-09 | 1,765 | [PDF](https://maskina.is/wp-content/uploads/2025/10/2025-10-Fylgi-Althingi_Maskinuskyrsla.pdf) ([maskina.is](https://maskina.is/fylgi-midflokksins-eykst/)) | Composite: 3.–8. október + 8.–15. október 2025; svarendur 1.765. **UPGRADED 2026-09-23: whole-number values replaced by the PDF's 1-dp values** (S 29,4 / D 15,9 / C 16,1 / M 13,8 / B 6,5 / F 6,3 / P 4,9 / V 4,0 / J 3,0). **CORRECTION: the source link used to point to Vísir `20252820991d`, which is the 22 December 2025 article, not this reading** |
| 2025-11-10 | 1,741 | [Vísir](https://www.visir.is/g/20252806182d/mid-flokkur-skakar-sjalf-staedis-flokknum-stor-merki-leg-nidur-stada-) ([RÚV](https://www.ruv.is/frettir/innlent/2025-11-20-midflokkurinn-staerstur-haegri-flokka-459402/), [maskina.is dashboard](https://maskina.is/fylgi-flokka-a-althingi/)) | Composite: 3.–10. nóvember + 13.–18. nóvember 2025 (Vísir chart caption). Side-publication for Vísir, with no PDF. **CORRECTION: n_total was an estimate of 1,500 and is now 1,741, the sum of the dashboard's `Fjöldi` counts. UPGRADED: whole-number values replaced by 1-dp values** (S 29,1 / M 17,3 / D 15,3 / C 13,5 / B 6,6 / F 5,6 / P 4,9 / V 4,8 / J 2,8). M is 17,3 per Maskína's dashboard and RÚV's `pollsArray`; Vísir's line chart has 17,2 |
| 2025-12-08 | 1,893 | [Vísir](https://www.visir.is/g/20252820991d/ny-konnun-maskinu-vaeri-al-veg-ny-stada-i-is-lenskum-stjorn-malum-) ([maskina.is dashboard](https://maskina.is/fylgi-flokka-a-althingi/)) | **The field period was never published, so the date is ESTIMATED** as publication (22 Dec) − 14 d, Maskína's median midpoint-to-publication lag over 18 dated readings. The Vísir article and both of its Infograms give no dates and no n. svarendur 1.893 is the sum of the dashboard counts (100,0%). **BACKFILLED 2026-09-23**. Media-only. Second consecutive Maskína reading with M ahead of D (after 2025-11-10) |
| 2026-01-11 | 886 | [Vísir](https://www.visir.is/g/20262832055d/mid-flokkurinn-nalgast-sam-fylkingu) | Fielded 9.–13. janúar 2026; svarendur 886 (91,2% af úrtaki). Small single-period sample. Dashboard counts sum to 886 (confirmed 2026-09-23) |
| 2026-02-10 | 1,993 | [mbl.is](https://www.mbl.is/frettir/innlent/2026/02/24/fylgi_midflokksins_laekkar/) ([maskina.is dashboard](https://maskina.is/fylgi-flokka-a-althingi/)) | Maskína fyrir Sýn-fréttir, published 24 Feb 2026 in Sýn's kvöldfréttir; side-publication with no Maskína PDF or article, and mbl is paywalled. Per-party values match the dashboard and RÚV: S 27,2 / M 19,0 / D 16,2 / C 13,4 / B 7,0 / P 5,2 / F 4,8 / V 4,1 / J 3,1. **REDATED 2026-09-23: this row was dated 2026-02-24, its publication date. The field period was never published, so the date is now ESTIMATED as publication − 14 d, the same rule as 2025-12-08.** `n_total` 1.993 was earlier recorded as a best estimate; it equals the sum of the dashboard's `Fjöldi` counts exactly, so it now has a Maskína-side source. It was not one of the independent calibration points |
| 2026-03-08 | 2,617 | [Vísir](https://www.visir.is/g/20262859852d/fylgi-sam-fylkingar-ekki-verid-minna-i-eitt-ar) ([PDF](https://maskina.is/wp-content/uploads/2026/03/2026-03-Fylgi-Althingi_Maskinuskyrsla.pdf)) | Composite: 26. feb.–3. mars + 12.–19. mars + 16.–19. mars 2026; svarendur 2.617 |
| 2026-04-05 | 1,786 | [Vísir](https://www.visir.is/g/20262871996d/sam-fylking-og-sjalf-staedis-flokkur-haekka-flugid) ([maskina.is](https://maskina.is/sjalfstaedisflokkurinn-a-uppleid-samfylkingin-afram-staerst-flokka-a-landsvisu/), [PDF](https://maskina.is/wp-content/uploads/2026/04/2026-04-Fylgi-Althingi_Maskinuskyrsla.pdf)) | Composite: 25.–31. mars + 8.–16. apríl 2026; svarendur 1.786 |
| 2026-04-29 | 2,810 | [Vísir](https://www.visir.is/g/20262886714d/sjalfstaedisflokkurinn-enn-a-flugi) ([maskina.is dashboard](https://maskina.is/fylgi-flokka-a-althingi/)) | Composite of three waves: 17.–24. apríl, 29. apríl – 6. maí og 7.–12. maí 2026; svarendur 2.810 ("Alls tóku samanlagt 2.810 svarendur afstöðu til flokks"; the dashboard counts sum to 2.809). A national reading fielded alongside the sveitarstjórnarkosningar polls. **BACKFILLED 2026-09-23**. Media-only. Midpoint 12,5 floored |
...
| 2026-07-02 | 963 | [PDF](https://maskina.is/wp-content/uploads/2026/07/2026-07-Fylgi-Althingi_Maskinuskyrsla.pdf) ([maskina.is](https://maskina.is/sjalfstaedisflokkurinn-a-flugi/), [Vísir](https://www.visir.is/g/20262912056d/sjalfstaedisflokkur-maelist-staerstur)) | Fielded 26. júní – 8. júlí 2026; svarendur 963 (91% gáfu upp afstöðu). Regular monthly reading, published 21–22 July. Per-party direct from the PDF's `Niðurstöður` table with raw counts: D 25,0 (240) / S 24,4 (235) / M 13,4 (129) / C 12,7 (122) / B 6,6 (64) / F 5,9 (57) / V 4,9 (47) / J 4,0 (39) / P 3,1 (30); `Gild svör` 963 = 100,0%, so Annað 0,0. First Maskína reading since March 2025 (2025-03-12) with **D ahead of S**. **Field-period discrepancy: the maskina.is article says "frá 28. júní til 8. júlí" but the PDF methodology page says "26. júní til 8. júlí". PDF used (skill convention), and independently corroborated by [Vísir 30 July](https://www.visir.is/g/20262915223d/dregur-ur-anaegju-med-frammistodu-rikisstjornarflokkanna) on the same field wave ("framkvæmd dagana 26. júní til 8. júlí"). Midpoint 26 Jun–8 Jul = 2 July; the article's dates would give 3 July** |
| 2026-08-01 | 3,172 | [RÚV](https://www.ruv.is/frettir/innlent/2026-08-20-samfylkingin-maelist-staerst-a-althingi-a-ny-484481) ([Vísir](https://www.visir.is/g/20262923931d/sam-fylkingin-aftur-staerst-en-rikis-stjornin-stendur-i-stad)) | Fielded in two waves, 22.–29. júlí and 7.–11. ágúst 2026; svarendur 3.172 ("Alls tóku 3.172 svarendur afstöðu til flokka"). **Media-only release — no maskina.is article and no `2026-08` Maskínuskýrsla PDF exists**, so the usual PDF citation is unavailable; per-party values taken from the RÚV article's embedded Highcharts `pollData` (S 26,2 / D 25,1 / M 12,7 / C 11,5 / B 7,8 / F 5,2 / V 4,2 / J 3,9 / P 3,5). The nine named parties sum to **100,1%**, so `pmax(0, …)` clamps Annað to 0,0. Composite poll: date is the linear midpoint of the full 22 Jul – 11 Aug span (= 1 Aug), per the skill's composite rule. **Maskína's dashboard text gives "3.460 svarendur" for this reading, but its per-party counts sum to exactly 3.172 (= RÚV/Vísir), so 3.172 stands** (3.460 is probably total respondents, including those who named no party) |
| 2026-09-02 | 4,544 | [Vísir](https://www.visir.is/g/20262938275d/fylgi-haggast-varla-eftir-at-kvaeda-greidslu) ([Vísir Infogram](https://e.infogram.com/120df4ad-46bb-41ce-be41-e7f86616dbde)) | Composite of three waves: 21.–25. ágúst, 27.–28. ágúst og 8.–14. september 2026; svarendur 4.544 ("alls tóku 4.544 afstöðu til flokks"). Published 23 Sept as Maskína's septembermæling, the first reading after the ESB-viðræður referendum. **Media-only release again** — no maskina.is article and the `2026-09` Maskínuskýrsla PDF 404s. Per-party values from the article's embedded Infogram bar chart (labelled "Könnun Maskínu - 22. september 2026"): S 27,5 / D 25,0 / M 13,0 / C 11,9 / B 7,5 / V 4,5 / F 4,3 / P 3,3 / J 3,0; the prose agrees on every party ("tuttugu og fimm" = D, "þrettán" = M, "ríflega þrjú" = P, "þremur" = J). The nine named parties sum to exactly **100,0%**, so Annað is 0,0. The prose's government total of 43,6% is 0,1 below S+C+F of the rounded values (43,7), i.e. rounding of the unrounded figures, not a data error. Composite poll: date is the linear midpoint of the full 21 Aug – 14 Sep span (24 days, exactly 2 Sept) |
...
- **[2026-09-23]** Ingested **Maskína september 2026** (`2026-09-02`, svarendur 4.544,
  three waves 21. ágúst – 14. september) and then **reconciled the whole Maskína block**,
  which turned out to hold only 11 of Maskína's 22 post-election readings. The block now
  has all 22, each checked against at least two independent sources.
  - **Discovery.** Vísir's Infogram bar chart (source 4 above) lists every reading. It
    exposed **11 readings missing from the tribble**: janúar–september 2025 (9),
    desember 2025 and maí 2026. It also exposed **3 rows stored as whole-number
    roundings** (up to 0,5 pp off): 2024-12-12, 2025-10-09 and 2025-11-10.
  - **Sources.** Seven readings have a Maskínuskýrsla PDF (the WP media API lists
    exactly 11 PDFs since the election). For the media-only readings, `svarendur`
    came from summing the dashboard's `Allir` tooltip counts. That method matched
    **exactly** on the three readings with an independently published n (2025-07
    PDF 1.855; 2026-01 Vísir 886; 2026-08 RÚV/Vísir 3.172). It also agreed within the
    rounding or sub-pixel slack on three more (2025-01 966, 2025-03 1.899, 2026-04-29
    2.810). 2026-02's 1.993 also equals the dashboard sum exactly, but that n had been
    an estimate, so it does not count as a calibration point. Field periods came
    from verbatim Vísir quotes; seven agents searched, and every quote was re-fetched
    and string-matched.
  - **Values: three-way agreement.** Every backfilled value matches across the
    Infogram, the dashboard and (where they exist) the PDF and RÚV's `pollsArray`.
    There were two exceptions, both chart slips, and the primary source was used:
    2025-08 B (Infogram bar 6,3 against PDF 6,5) and 2025-11 M (Infogram line 17,2
    against dashboard/RÚV 17,3).
  - **Estimated dates (4 rows, flagged in-table).** 2025-02-19, 2025-04-15, 2025-12-08
    and the re-dated 2026-02-10 have no published start date. Rules: end − 7 d when
    only the end is known (median half-span, 11 readings), else publication − 14 d
    (median lag, 18 readings; range 4–21 d). Expected error is about ±7 d.
  - **Corrections to existing rows.** The 2025-11-10 n changed from 1.500 (an estimate)
    to 1.741. The 2026-02-24 row was re-dated to 2026-02-10 (it had been stored at its
    publication date), and its n 1.993 is now confirmed. The 2025-10-09 source link
    pointed at the December 2025 article.
  - **Confirmed, not changed.** The 2026-08-01 n 3.172 stands: the dashboard's
    free-text line says 3.460, but its counts sum to 3.172.
  - **Supersedes the 2026-05-20 entries below**: they call the dashboard "not
    programmatically scrapable" and n-checking via it "not worth the effort". Their
    open items ("1,500 should be re-verified", the 2026-02-24 row) are resolved above.
    The dropdown options are DOM elements; only the chart is canvas.
  - **Floor-of-midpoint convention holds for Maskína** too: all 3 pre-existing rows
    with a ,5 midpoint (2025-11-10, 2026-03-08, 2026-06-06) were floored.
