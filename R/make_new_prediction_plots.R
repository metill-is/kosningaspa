...
plots <- d |>
  ...
  group_map(
    function(data, ...) {
      ...
      ggsave(
        plot = p_tab,
        filename = here("Figures", "Historical", "Sharing", glue("{fit_date}.png")),
        width = 8,
        height = 0.55 * 8,
        scale = 1.4,
        bg = "#fdfcfc"
...
plots <- d |>
  ...
  group_map(
    function(data, ...) {
      ...
      ggsave(
        plot = p_tab,
        filename = here("Figures", "Historical", "Background", glue("{fit_date}_background.png")),
        width = 8,
        height = 0.55 * 8,
        scale = 1.4,
        bg = "#fdfcfc"
      ...
      ggsave(
        plot = p_tab,
        filename = here("Figures", "Historical", "Transparent", glue("{fit_date}_transparent.png")),
        width = 8,
        height = 0.55 * 8,
        scale = 1.4,
        bg = "transparent"
