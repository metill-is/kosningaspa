...
get_hardcoded_polls <- function() {
  ...
  polls_wide <- tribble(
    ...
    "2025-12-15",  "Gallup",    9091,      30.9,  16.8,  5.2,   10.9,  21.7,  5.5,   3.4,   3.6,   1.6,
    "2026-01-15",  "Gallup",    9713,      31.2,  17.1,  5.4,   11.3,  20.8,  5.3,   3.4,   3.1,   1.9,
    ...
    "2026-06-06",  "Maskína",   1700,      25.2,  22.7,  8.5,   12.4,  14.2,  4.1,   3.5,   5.4,   3.9
  )
